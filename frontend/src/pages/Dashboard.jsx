...
import { FaRecycle, FaUsers, FaChartLine, FaDollarSign, FaBoxOpen } from 'react-icons/fa';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          ...
          <div className="space-y-3">
            <button className="w-full p-3 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors">
              Add New Listing
            </button>
            <button className="w-full p-3 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors">
              Generate Report
            </button>
            <button className="w-full p-3 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-colors">
              Manage Users
            </button>
            <button className="w-full p-3 bg-yellow-100 text-yellow-700 rounded-lg hover:bg-yellow-200 transition-colors">
              System Settings
            </button>
          </div>
        </div>
